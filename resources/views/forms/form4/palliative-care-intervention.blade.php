        ...
        @foreach([
            ...
            <div class="mb-4 border p-2">
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" name="{{ $key }}_care" value="Yes" class="form-check-input rounded-circle" onclick="toggleSection('{{ $key }}Details')">
                    <label class="form-check-label">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input type="radio" name="{{ $key }}_care" value="No" class="form-check-input rounded-circle" onclick="toggleSection('{{ $key }}Details')" checked>
                ...
                <div id="{{ $key }}Details" class="d-none mt-2">
                    ...
                    <div class="form-check form-check-inline">
                        <input type="radio" name="{{ $key }}_place" value="Home" class="form-check-input rounded-circle">
                        <label class="form-check-label">Home</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" name="{{ $key }}_place" value="Hospital" class="form-check-input rounded-circle">
                        <label class="form-check-label">Hospital</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" name="{{ $key }}_place" value="Community-based" class="form-check-input rounded-circle">
                    ...
                    <div class="form-check form-check-inline">
                        <input type="radio" name="{{ $key }}_improved" value="Yes" class="form-check-input rounded-circle">
                        <label class="form-check-label">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" name="{{ $key }}_improved" value="No" class="form-check-input rounded-circle">
                        <label class="form-check-label">No</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" name="{{ $key }}_improved" value="Not assessed" class="form-check-input rounded-circle">
